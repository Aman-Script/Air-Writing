...
def main():
    ...
    while True:
        ...
        if not ret or frame is None or frame.shape[0] == 0 or frame.shape[1] == 0:
            print("Error: Failed to capture frame or frame is empty!")
            break
        ...
        # Ensure that originalFrame is valid before showing
        if originalFrame is not None and originalFrame.shape[0] > 0 and originalFrame.shape[1] > 0:
